...
/// The View of the operation's editor.
///
/// Allows to create an operation or edit the information inside one.
class OperationEditorView extends StatelessWidget {
  /// The initial operation to initialize the fields with.
  final Operation initialOperation;

  const OperationEditorView({Key key, @required this.initialOperation})
      : super(key: key);

  /// Displays the date picker and sets the date in the view model.
  Future<void> _selectDate(
      BuildContext context, OperationEditorViewModel model) async {
    // Displays a date picker with a 2 year interval around the current date.
